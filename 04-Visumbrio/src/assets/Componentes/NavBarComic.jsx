        ...
        <div className="collapse navbar-collapse justify-content-end" id="navbarNav">
          <ul className="navbar-nav ms-auto align-items-center"> 
            ...
            <li className="nav-item mx-2">
              <a className="nav-link" aria-current="page" href="#" style={{color: '#000000', fontFamily: 'serif', fontSize: '1.15rem', opacity: 0.7, transition: 'opacity 0.2s'}}>
                Inicio
              </a>
            </li>
            
            {/* 📘 Cómic (Activo con la rayita) */}
            <li className="nav-item mx-2">
            ...
            <li className="nav-item d-flex align-items-center ms-3">
                <img className='rounded-4' src="./Cuenta.png" alt="Cuenta" style={{width: '3.5rem', height: '3.5rem', objectFit: 'cover'}}/>
            </li>
          </ul>
        </div>
      </div>
